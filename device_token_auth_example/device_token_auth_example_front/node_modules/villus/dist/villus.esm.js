/**
  ...
  * @license MIT
  */
import { isRef, isReactive, computed, unref, getCurrentInstance, inject, provide, defineComponent, h, ref, watch, onMounted, toRef, onBeforeUnmount } from 'vue';
...
export { Client, CombinedError, Mutation, Provider, Query, Subscription, VILLUS_CLIENT, cache, createClient, dedup, defaultPlugins, definePlugin, fetch, getActiveClient, getQueryKey, handleSubscriptions, setActiveClient, useClient, useMutation, useQuery, useSubscription, withProvider };
